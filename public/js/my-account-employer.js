$(function(){
    $('.change-password').on('click', function () {
        $('.employer-account-password-inner').toggleClass('displayNone');
    ...
    $('.change-email').on('click', function () {
        $('.employer-account-email-inner').toggleClass('displayNone');
    ...
    $('.delete-account').on('click', function () {
        $('.employer-account-delete-inner').toggleClass('displayNone');
    ...
    $('.billing-history-btn').on('click', function () {
        $('.invoice-history-modal').show(300);
    })
